    ...
    <div style={{ position: 'relative', display: 'flex', flexDirection: 'column', minHeight: '100vh', overflowX: 'hidden' }}>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '4rem', alignItems: 'center', width: '100%', margin: 'auto' }}>
          ...
          <div className="animate-fade-in-up hero-col">
            ...
            <h1 style={{ fontSize: 'clamp(3rem, 6vw, 4.5rem)', fontWeight: 800, lineHeight: 1.05, marginBottom: '1.5rem', letterSpacing: '-0.03em', color: '#ffffff' }}>
              Master Any Subject with <span style={{ background: 'linear-gradient(to right, #818cf8, #c084fc, #38bdf8)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', display: 'inline-block' }}>Interactive</span> Quizzes
            </h1>
          ...
          <div className="animate-fade-in-up delay-200 hero-col-right">
            <div className="mockup-card" style={{ 
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                ...
                <div style={{ padding: '1.25rem', borderRadius: '12px', border: '1px solid rgba(129, 140, 248, 0.5)', background: 'linear-gradient(90deg, rgba(79, 70, 229, 0.2) 0%, rgba(79, 70, 229, 0.05) 100%)', display: 'flex', alignItems: 'center', gap: '1.25rem', boxShadow: 'inset 0 0 20px rgba(129, 140, 248, 0.1)', transform: 'translateX(10px)' }}>
                  <div style={{ width: '24px', height: '24px', borderRadius: '50%', background: '#818cf8', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 0 15px rgba(129, 140, 248, 0.5)' }}>
            ...
            <div style={{ position: 'absolute', top: '10%', right: '0%', width: '200px', height: '200px', background: '#38bdf8', opacity: 0.15, filter: 'blur(50px)', zIndex: -1 }}></div>
            <div style={{ position: 'absolute', bottom: '10%', left: '0%', width: '250px', height: '250px', background: '#c084fc', opacity: 0.15, filter: 'blur(60px)', zIndex: -1 }}></div>
          </div>
        </div>
      </section>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(12, 1fr)', gap: '1.5rem', gridAutoRows: 'minmax(340px, auto)' }}>
          ...
          <div className="bento-card" style={{ background: 'rgba(15, 23, 42, 0.4)', backdropFilter: 'blur(20px)', border: '1px solid rgba(255, 255, 255, 0.05)', borderRadius: '24px', padding: '3rem', position: 'relative', overflow: 'hidden', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', boxShadow: 'inset 0 1px 0 rgba(255, 255, 255, 0.1)' }}>
            ...
            <div style={{ position: 'absolute', top: '15%', right: '10%', display: 'flex', gap: '-10px', zIndex: 1 }}>
              <div style={{ width: '60px', height: '60px', borderRadius: '50%', background: 'linear-gradient(45deg, #f43f5e, #ec4899)', border: '3px solid #0f172a', zIndex: 3, boxShadow: '0 10px 20px rgba(0,0,0,0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', fontWeight: 'bold' }}>JD</div>
              <div style={{ width: '60px', height: '60px', borderRadius: '50%', background: 'linear-gradient(45deg, #8b5cf6, #a855f7)', border: '3px solid #0f172a', zIndex: 2, transform: 'translateX(-20px)', boxShadow: '0 10px 20px rgba(0,0,0,0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', fontWeight: 'bold' }}>SK</div>
              <div style={{ width: '60px', height: '60px', borderRadius: '50%', background: 'linear-gradient(45deg, #10b981, #34d399)', border: '3px solid #0f172a', zIndex: 1, transform: 'translateX(-40px)', boxShadow: '0 10px 20px rgba(0,0,0,0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', fontWeight: 'bold' }}>+12</div>
            </div>
          ...
          <div className="bento-card" style={{ background: 'rgba(15, 23, 42, 0.4)', backdropFilter: 'blur(20px)', border: '1px solid rgba(255, 255, 255, 0.05)', borderRadius: '24px', padding: '3rem', position: 'relative', overflow: 'hidden', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', boxShadow: 'inset 0 1px 0 rgba(255, 255, 255, 0.1)' }}>
             ...
             <div style={{ position: 'absolute', top: '15%', right: '10%', width: '40%', display: 'flex', flexDirection: 'column', gap: '0.75rem', zIndex: 1 }}>
               <div style={{ height: '8px', width: '100%', background: 'rgba(255,255,255,0.05)', borderRadius: '4px' }}>
                 <div style={{ height: '100%', width: '85%', background: '#38bdf8', borderRadius: '4px', boxShadow: '0 0 10px #38bdf8' }}></div>
               </div>
               <div style={{ height: '8px', width: '100%', background: 'rgba(255,255,255,0.05)', borderRadius: '4px' }}>
                 <div style={{ height: '100%', width: '60%', background: '#818cf8', borderRadius: '4px' }}></div>
               </div>
               <div style={{ height: '8px', width: '100%', background: 'rgba(255,255,255,0.05)', borderRadius: '4px' }}>
                 <div style={{ height: '100%', width: '45%', background: '#c084fc', borderRadius: '4px' }}></div>
               </div>
             </div>
      ...
      <section className="container" style={{ position: 'relative', zIndex: 1, padding: '8rem 0', borderTop: '1px solid rgba(255, 255, 255, 0.05)' }}>
        ...
        <div className="timeline-grid" style={{ position: 'relative' }}>
          ...
          <div style={{ textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', position: 'relative', zIndex: 1 }}>
            <div style={{ width: '96px', height: '96px', borderRadius: '50%', background: '#09090b', border: '1px solid rgba(129, 140, 248, 0.4)', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '2rem', fontSize: '2rem', fontWeight: 800, color: '#818cf8', boxShadow: 'inset 0 0 30px rgba(129, 140, 248, 0.2), 0 0 40px rgba(129, 140, 248, 0.1)' }}>1</div>
          ...
          {/* Step 2 */}
          <div style={{ textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', position: 'relative', zIndex: 1 }}>
            <div style={{ width: '96px', height: '96px', borderRadius: '50%', background: '#09090b', border: '1px solid rgba(192, 132, 252, 0.4)', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '2rem', fontSize: '2rem', fontWeight: 800, color: '#c084fc', boxShadow: 'inset 0 0 30px rgba(192, 132, 252, 0.2), 0 0 40px rgba(192, 132, 252, 0.1)' }}>2</div>
          ...
          {/* Step 3 */}
          <div style={{ textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', position: 'relative', zIndex: 1 }}>
            <div style={{ width: '96px', height: '96px', borderRadius: '50%', background: '#09090b', border: '1px solid rgba(56, 189, 248, 0.4)', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '2rem', fontSize: '2rem', fontWeight: 800, color: '#38bdf8', boxShadow: 'inset 0 0 30px rgba(56, 189, 248, 0.2), 0 0 40px rgba(56, 189, 248, 0.1)' }}>3</div>
      ...
      <section className="container" style={{ position: 'relative', zIndex: 1, padding: '4rem 0 8rem 0' }}>
        <div style={{ background: 'linear-gradient(180deg, rgba(30, 41, 59, 0.6) 0%, rgba(15, 23, 42, 0.8) 100%)', backdropFilter: 'blur(40px)', border: '1px solid rgba(255, 255, 255, 0.1)', borderRadius: '32px', padding: '5rem 2rem', textAlign: 'center', position: 'relative', overflow: 'hidden', boxShadow: '0 40px 80px rgba(0, 0, 0, 0.8), inset 0 1px 0 rgba(255, 255, 255, 0.1)' }}>
          <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', width: '100%', height: '100%', background: 'radial-gradient(circle, rgba(129, 140, 248, 0.15) 0%, transparent 60%)', zIndex: 0 }}></div>
